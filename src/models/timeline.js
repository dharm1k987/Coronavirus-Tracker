...
const postTimeline = async (timeline, type) => {
  ...
  if (timeline.country == 'CZECHIA') timeline.country = 'CZECH REPUBLIC';
  if (timeline.country == 'GUINEABISSAU') timeline.country = 'GUINEA-BISSAU';
  if (timeline.country == 'TIMORLESTE') timeline.country = 'TIMOR-LESTE';
  if (timeline.country == 'CAR') timeline.country = 'CENTRAL AFRICAN REPUBLIC';
